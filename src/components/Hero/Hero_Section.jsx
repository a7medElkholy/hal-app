...
const ActionButton = ({ text, className }) => (
  <a href="#" className={`flex hover:text-white text-black items-center justify-center gap-4 px-4 py-4 border-2 bg-white hover:border-white rounded-full text-lg font-semibold transition-all duration-300 hover:bg-transparent hover:scale-101 ${className}`}>
    ...
    <div className="bg-[#013366] text-white p-2 hover:scale-102 rounded-full ">
      <ArrowIcon />
    </div>
  </a>
);
      ...
      <main className="relative z-10 flex-grow flex items-center w-full">
        <div className="xl:container mx-auto grid grid-cols-1 lg:grid-cols-2 items-center px-4 sm:px-8">
          <div className="flex flex-col items-start leading-relaxed ">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl leading-relaxed font-extrabold">
              نُطوِّر أعمالك بحلول
              <br />
              ذكاء اصطناعي مبتكرة
            </h1>
      ...
      <main className="relative z-10 flex-grow flex items-center w-full">
        <div className="container mx-auto grid grid-cols-1 items-center px-4 sm:px-8 text-center">
          <div className="flex flex-col items-center leading-relaxed">
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-relaxed">
              نُطوِّر أعمالك بحلول ذكاء
              <br />
              اصطناعي مبتكرة
            </h1>
            <p className="mt-6 text-lg sm:text-xl max-w-2xl text-gray-200 ">
              ساعدك على الابتكار والأتمتة وتوسيع أعمالك من خلال حلول ذكاء اصطناعي وتقنيات
              <br /> متقدمة مصممة خصيصًا لنجاحك في سوق سريع التغير.
            </p>
            <div className="mt-10">
              <ActionButton text="ابدء رحلتك الان!" />
            </div>
